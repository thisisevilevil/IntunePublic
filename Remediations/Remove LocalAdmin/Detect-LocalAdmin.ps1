...
if ($localadmins -like $localuser) {Write-output "Localadmin $localuser user is in the local admin group. Proceeding to remediation" ; exit 1}
    else {Write-output "$localuser is not part of the local admin group."}